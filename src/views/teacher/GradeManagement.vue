  ...
  <div class="grade-management">
    <el-card>
      ...
      <el-row :gutter="20" style="margin-bottom: 20px">
        <el-col :span="6">
          <el-statistic title="可打分学期数" :value="statistics.availableSemesters" />
        </el-col>
        <el-col :span="6">
          <el-statistic title="进行中学期" :value="statistics.activeSemesters" />
        </el-col>
        <el-col :span="6">
          <el-button type="success" @click="handleViewProof" style="margin-top: 10px">
      ...
      <el-empty v-if="!loading && semesters.length === 0" description="暂无可打分的学期" />
    </el-card>
    ...
    >
      <el-descriptions :column="2" border>
        ...
        <el-descriptions-item label="课程数">{{ currentSemester.courseCount || 0 }}</el-descriptions-item>
...
const statistics = computed(() => {
  ...
  return {
    ...
    totalCourses: allSemesters.reduce((sum, s) => sum + (s.courseCount || 0), 0)
  }
})
...
const loadAvailableSemesters = async () => {
  ...
  try {
    ...
    const response = await teacherAPI.getAvailableSemesters(params)
