...
export const HTTPS_CONFIG = {
  ...
  oauthCallbackUrl: import.meta.env.VITE_OAUTH_CALLBACK_URL || 'https://localhost:5173/callback/university',
  apiBaseUrl: import.meta.env.VITE_API_BASE_URL || 'https://grades.fiona.local'
}
